import bpy
from . import StrewUi, StrewManOperators, __init__, StrewProps
...
class BiomeCreation():
    ...
    def GetBiome(self, BiomeName, OriginalObject):
        AssetCount = 0
        ...
        if Master_Tree.nodes.get('Object Info'):
            ...
            Object_Node.inputs[0].default_value = OriginalObject[
                0]  # TODO QUICKLY: MAKE IT HANDLE MULTIPLE OBJECT SELECTION
...
class ApplyGrass():
    def ApplyGeonode(self,context):
        ...
        try:
            ...
            Strew_Terrain.node_group = bpy.data.node_groups[StrewUi.variables("GeonodeMasterName")]
